...
export const FAQSection = () => (
    <div className="w-full bg-4 flex flex-col items-center mt-40 overflow-hidden">
        ...
        <div className="flex justify-center w-full md:space-x-52">
            <div className="flex flex-col space-y-3">
                <div className="flex space-x-3">
                    <div className="rounded-full bg-purple-500 w-[20px] h-[20px] md:w-[30px] md:h-[30px] "/>
                    <p className="text-white text-[10px] md:text-[14px]">Cartão de Crédito</p>
                </div>
                <div className="flex space-x-3">
                    <div className="rounded-full bg-purple-500 w-[20px] h-[20px] md:w-[30px] md:h-[30px] "/>
                    <p className="text-white text-[10px] md:text-[18px]">Pix</p>
                </div>
                <div className="flex space-x-3">
                    <div className="rounded-full bg-purple-500 w-[20px] h-[20px] md:w-[30px] md:h-[30px] "/>
                    <p className="text-white text-[10px] md:text-[18px]">Boleto</p>
                </div>
            </div>
            <div className="flex flex-col">
                <h1 className="text-white text-lg md:text-3xl font-semibold">Taxas e Tarifas</h1>
                <h2 className="text-gray-400 text-[15px] md:text-[20px] max-w-[70%] md:max-w-[400px] mb-5">Custos Reduzidos e Altas Taxas de Aprovação para Impulsionar Seu Negócio</h2>
                <LoginButton/>
            </div>
        </div>
